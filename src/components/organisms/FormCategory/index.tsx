    ...
    .object({
        ...
        image: z
            .number({
                ...
                invalid_type_error: "Esse formato não é válido",
            })
            .min(1, { message: "Arquivo precisa ter pelo meni 1 bit" }),
    }).required();
        ...
        <div className={formCategoryClass}>
            <form className="w-fit" onSubmit={handleSubmit(handleAddCategory)}>
                ...
                <FormGroup
                    ...
                    className="w-12/12 mb-3"
                >
                    <Textarea id="image" {...register('image')} />
                </FormGroup>
                <FormError isError={!!errors.image} text={errors.image?.message ?? ''} />
